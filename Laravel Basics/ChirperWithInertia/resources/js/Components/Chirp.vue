...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <form if-v="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })">
            ...
            <p v-if="!editing" class="mt-4 text-lg text-gray-900">{{ chirp.message }}</p>
        </div>
    </div>
</template>
